...
if (isset($_GET['transactionID']) && $_GET['transactionID']) {
    $sqlUpdate = "UPDATE donhang SET loai = 2, trangthai = 1 WHERE id =  " . $_GET['transactionID'];
    ...
    if ((isset($_SESSION['cart'])) && count($_SESSION['cart']) > 0) {
        ...
        if ($loai == 2) {
            ...
            curl_setopt_array($curl, array (
                ...
                CURLOPT_URL            => 'http://topcode.fun/api/v1/payment/add',
                CURLOPT_USERAGENT      => 'QUANAO',
                CURLOPT_POST           => 1,
...
//                    'url_return' => ''
                    'service_code' => 'QUANAO',
                    'url_return'   => "http://localhost:8000/danh-sach-gio-hang.php?pay=online&transactionID=$id_instart",
                    'amount'       => $data['tongtien']
                ))
            ));
            $resp = curl_exec($curl);
                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="" style="display: flex;justify-content: center">
                            <input type="submit" name="" value="ĐẶT HÀNG" class="my-button"
                                   style="flex: 0 0 100%; margin-top: 10px">
                        </div>
                    </form>
                </div>
            </div>
