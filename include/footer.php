        ...
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                <a href="" class="text-decoration-none">
                    <img src="https://thuvienlogo.com/data/03/logo-may-vi-tinh-06.jpg" alt="" style="width: 200px;margin-bottom: 10px;">
<!--                    <img src="--><?php //= base_url() ?><!--/public/logo.png" alt="" style="width: 200px;margin-bottom: 10px;">-->
                </a>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i> 298 Cầu Diễn, Từ Liêm, HN</p>
                <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>0352.90.22.55</p>
            </div>
        ...
        <div class="row border-top border-light mx-xl-5 py-4">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-dark">
                    &copy; <a class="text-dark font-weight-semi-bold" href="https://www.facebook.com/cung2408">Design by :  Cung </a><br>
                    <!-- <a class="text-dark font-weight-semi-bold" href="https://htmlcodex.com">HTML Codex</a><br> -->
                     <a href="#" target="_blank">Đồ án tốt nghiệp</a>
                </p>
            </div>
