                        ...
                        <form id="demo-form2" action="" method="POST" class="form-horizontal form-label-left bor"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="first-name"> Giá Nhập <span
                                                class="required">(*)</span> </label>
                                    <div class="col-md-8">
                                        <input type="number" id="first-name" name="gianhap" class="form-control"
                                               value="<?php echo isset($gianhap) ? $gianhap : '' ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="first-name"> Giá <span class="required">(*)</span>
                                    </label>
                                    <div class="col-md-8">
                                        <input type="number" id="first-name" name="gia" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" id="first-name" min="0" max="100" name="giamgia"
                                               class="form-control" value="<?php echo isset($gia) ? $gia : '0' ?>">
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <label class="custom-file-upload col-md-11">
                                            ...
                                            <input type="file" accept="image/*" name="hinhanh"
                                                   onchange="loadFileThunbar(event)" class="col-md-12">
                            ...
                            <div class="col-md-9 bor">
                                    ...
                                    <div class="col-md-10">
                                        <select class="form-control" name="danhmuc_id">
                                            ...
                                            <?php foreach ($danhmucsort as $item) : ?>
                                                <option value="<?php echo $item['id'] ?>"> <?php $str = '';
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-2"> Nhà cung cấp <span
                                                class="required">(*)</span></label>
                                    <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="tensanpham" class="form-control col-md-7 col-xs-12"
                                               value="<?php echo isset($tensanpham) ? $tensanpham : '' ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-2" for="first-name"> Số lượng <span
                                                class="required">(*)</span></label>
                                    <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-2" for="first-name"> Mô tả <span
                                                class="required">(*)</span>
                                    </label>
                                    <div class="col-md-10">
