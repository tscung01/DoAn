 ...
 */
$sql = " SELECT *, donhang.id as id_donhang, admin.name as tenship, admin.id as id_admin FROM donhang LEFT JOIN admin on admin.id = donhang.nhanviengiaohang_id  WHERE 1 ORDER BY donhang.id DESC";
...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <!-- hiện thông báo -->
        <?php include __DIR__ ."/../admin/layouts/notification.php"; ?>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <?php  foreach($donhang as $item) :?>
                            <tr>
                                <td><?php echo $item['id_donhang'] ?></td>
                                ...
                                <td>
                                    <?php if($item['trangthai'] == 0) :?>
                                        <a href="trangthai.php?id=<?php echo $item['id_donhang'] ?>" class="btn btn-xs btn-default trangthai-info" >Chưa thanh toán</a>
                                    <?php else : ?>
