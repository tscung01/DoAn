...
//    }
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        if (empty($error))
        {
            ...
            $admin = $db->fetchOne("nhanvien","email = '".$email."' AND matkhau = '".$password."'");
            ...
            else 
            {
                ...
                $_SESSION['nhanvien_name']    = $admin['name'];
                $_SESSION['nhanvien_id']      = $admin['id'];
                $_SESSION['admin_email']   = $admin['email'];
                $_SESSION['alertlogin'] = ' Đăng nhập thành công ' ;

                redirect("nhanvien/donhang.php");
            }   
        }
        else
        {
...
<!DOCTYPE html>
        ...
        <html lang="en">
            ...
            <head>
                <meta charset="utf-8"/>
                <title>  Đăng nhập hệ thông nhân viên </title>
            ...
            <body class="login">
                ...
                <div class="content" style="margin-top: 100px;"">
                    ...
                    <form class="login-form" action="" method="POST">
                        <h3 class="form-title"> Đăng nhập hệ thông nhân viên</h3>
